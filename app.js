...
// Configuration
const CONFIG = {
    NEWS_API_KEY: 'YOUR_API_KEY_HERE', // Replace with actual API key
...
const StockData = {
    "RELIANCE.NS": {
        ...
        "dayLow": 1366.0,
        "volume": "9.88M",
        "marketCap": "₹18,64,233 Cr",
        "peRatio": 22.85,
        "weekHigh52": 1500.0,
        "weekLow52": 1200.0,
        "chartData": {
            "labels": ["Sep 19", "Sep 20", "Sep 23", "Sep 24", "Sep 25", "Sep 26", "Today"],
            "prices": [1345.2, 1352.1, 1368.5, 1383.0, 1372.4, 1377.6, 1377.6],
            "predictions": [1350.0, 1360.0, 1375.0, 1390.0, 1380.0, 1385.0, 1422.43],
            "volumes": [8.5, 9.2, 7.8, 5.9, 11.4, 9.9, 9.8]
        }
    },
    "TCS.NS": {
        ...
        "dayLow": 2891.3,
        "volume": "3.70M",
        "marketCap": "₹10,48,920 Cr",
        "peRatio": 21.27,
        "weekHigh52": 4494.90,
        "weekLow52": 2991.60,
        "chartData": {
            "labels": ["Sep 19", "Sep 20", "Sep 23", "Sep 24", "Sep 25", "Sep 26", "Today"],
            "prices": [3125.5, 3142.8, 3158.2, 3035.4, 2957.4, 2899.8, 2899.8],
            "predictions": [3130.0, 3150.0, 3165.0, 3045.0, 2970.0, 2920.0, 3050.25],
    ...
    "INFY.NS": {
        ...
        "dayLow": 1441.2,
        "volume": "8.60M",
        "marketCap": "₹6,00,756 Cr",
        "peRatio": 21.31,
        "weekHigh52": 2006.45,
        "weekLow52": 1307.00,
        "chartData": {
            "labels": ["Sep 19", "Sep 20", "Sep 23", "Sep 24", "Sep 25", "Sep 26", "Today"],
            "prices": [1485.2, 1492.8, 1505.1, 1494.6, 1484.8, 1448.9, 1448.9],
            "predictions": [1490.0, 1500.0, 1510.0, 1500.0, 1490.0, 1460.0, 1520.75],
            "volumes": [8.5, 9.2, 7.8, 4.9, 9.5, 8.6, 15.7]
        }
    }
};
